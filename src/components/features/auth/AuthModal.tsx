        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                >
                    ...
                    {/* Outer Spotlight Div */}
                    <div className="w-full mx-auto [background:linear-gradient(45deg,#fff,theme(colors.gray.100)_50%,#fff)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.slate.200/.48)_80%,_#dc2626_86%,_#ef4444_90%,_#dc2626_94%,theme(colors.slate.200/.48))_border-box] rounded-[32px] border-2 border-transparent animate-border p-[1px]">

                        {/* Inner Content Div */}
                        <div className="relative w-full bg-white rounded-[31px] overflow-hidden">

                            {/* Header */}
                            <div className="h-32 bg-zinc-50 flex items-center justify-center relative border-b border-gray-100">
                                <button
                                    onClick={closeAuthModal}
                                    className="absolute top-4 right-4 p-2 rounded-full bg-white hover:bg-gray-100 transition-colors shadow-sm"
                                >
                                    <X className="h-4 w-4 text-gray-500" />
                                </button>
                                <div className="text-center space-y-2">
                                    <div className="w-12 h-12 rounded-2xl bg-white mx-auto flex items-center justify-center shadow-md shadow-red-100 text-2xl border border-gray-50">
                                        🍣
                                    </div>
                            ...
                            <div className="p-8 space-y-6">
                                <div className="space-y-4">
                                    <Button
                                        variant="outline"
                                        className="w-full h-12 rounded-xl border-gray-200 text-gray-700 hover:bg-red-50 hover:border-red-600 hover:text-red-600 font-medium transition-all"
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center text-xs uppercase tracking-wider">
                                        <span className="bg-white px-2 text-gray-400 font-medium">O con email</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    {view === 'signup' && (
                                        <input
                                            ...
                                            className="flex h-12 w-full rounded-xl border border-gray-200 bg-gray-50/50 px-4 py-2 text-sm text-black placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all"
                                    ...
                                    <Button
                                        ...
                                        disabled={isLoading}
                                        className="w-full h-12 rounded-xl bg-black text-white font-bold tracking-tight hover:bg-zinc-800 transition-all shadow-lg active:scale-[0.98]"
                                    >
